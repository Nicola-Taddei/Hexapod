...
% filename = 'trajectorydata.xlsx'; %uncomment to save data in Excel
% writematrix(Traj.x,filename);
% filename2 = 'trajectorydatay.xlsx';
% writematrix(Traj.y,filename2);
...
% plot(1250,4300,'g*')  %punto di arrivo